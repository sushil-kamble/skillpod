...
- `list` now parses folded YAML descriptions correctly and shows a short inline description instead of stray `>` markers.
- `edit` now labels the non-opening option as `Cancel` and treats it as an actual cancel action.
